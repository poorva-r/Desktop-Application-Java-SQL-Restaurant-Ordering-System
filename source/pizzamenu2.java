 ...
 * 
 */
public class pizzamenu2 extends javax.swing.JFrame {
Connection c = null;
Statement s = null;
ResultSet r = null;
    /**
     * Creates new form pizzamenu2
     */
    public pizzamenu2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        cb2.setText("Margherita");
        getContentPane().add(cb2);
        cb2.setBounds(350, 350, 180, 37);
        ...
        jButton1.setBounds(730, 10, 80, 30);

        jLabel1.setIcon(new javax.swing.ImageIcon("pizza2.png")); // NOI18N
        jLabel1.setText("jLabel1");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(0, 0, 830, 420);
...
try{
       ...
       String query = "Select*from order_details;";
        ...
        int pizza_amt = Integer.parseInt(j);
        if(cb1.isSelected())
        ...
        String query1 = "update order_details set pizza_amt="+pizza_amt+" where order_no="+num+";";
...
new drinksmenu().setVisible(true); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pizzamenu2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
