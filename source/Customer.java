...
ResultSet r = null;
    ...
    private void initComponents() {
        ...
        cdTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Order Number", "Name", "Address", "Contact Number"
            }
        ));
        jScrollPane1.setViewportView(cdTable);

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(50, 110, 600, 270);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("customer details.png")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        DefaultTableModel M=(DefaultTableModel )cdTable.getModel();
        try{
            ...
            while(r.next())
            {
                String o_no,name,address,contact;
                o_no = r.getString("order_no");
                name = r.getString("name");
                address = r.getString("address");
                contact = r.getString("contact");
                
                M.addRow(new Object[] { o_no,name,address,contact});
            }
            r.close();
            s.close();
            c.close();}
